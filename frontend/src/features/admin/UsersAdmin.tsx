    ...
    <div className="relative group/role inline-flex">
      <select
        ...
        className={`appearance-none cursor-pointer text-xs font-semibold rounded-lg px-3 py-1.5 pr-7 border transition-all duration-200 focus:outline-none focus:ring-2 ${
          isAdmin
            ? 'bg-primary-50 text-primary-700 border-primary-200 hover:bg-primary-100 focus:ring-primary-300 dark:bg-primary-500/20 dark:text-primary-300 dark:border-primary-500/40'
    ...
    <button
      ...
      className={`inline-flex items-center gap-1.5 text-xs font-semibold rounded-lg px-3 py-1.5 border transition-all duration-200 hover:scale-105 active:scale-95 ${
        active
          ...
          : 'bg-lives-50 text-lives-700 border-lives-200 hover:bg-lives-100 dark:bg-lives-500/15 dark:text-lives-300 dark:border-lives-500/30'
      }`}
    >
      <span
        className={`w-1.5 h-1.5 rounded-full flex-shrink-0 ${
          active ? 'bg-emerald-500' : 'bg-lives-500'
        }`}
      />
  ...
  return (
    <div className="space-y-4 animate-fade-in-up">
      ...
      <div className="grid grid-cols-3 gap-3">
        {[
          { label: "Jami foydalanuvchi", value: counts.total, color: "text-primary-600 dark:text-primary-400", bg: "bg-primary-50 dark:bg-primary-500/10" },
          { label: "Faol", value: counts.active, color: "text-emerald-600 dark:text-emerald-400", bg: "bg-emerald-50 dark:bg-emerald-500/10" },
          { label: "Adminlar", value: counts.admins, color: "text-primary-600 dark:text-primary-400", bg: "bg-primary-50 dark:bg-primary-500/10" },
        ].map((s) => (
